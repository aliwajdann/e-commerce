      ...
      <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 items-center gap-16 h-full">
        ...
        <div>
          ...
          <p className="text-lg text-muted dark:text-base-light mb-8">
            Discover the latest fashion trends for men and women. Quality, comfort, and elegance — all in one place.
          </p>
          <div className="flex gap-4">
            <Link href={'/products'} className="bg-fuchsia-500 text-white px-6 py-3 rounded-xl hover:opacity-90 transition">
              Shop Now

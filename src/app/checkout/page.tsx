  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <section
          className="lg:col-span-8 bg-white border border-gray-100 rounded-xl  p-5 sm:p-6 overflow-hidden"
        >
        ...
        <aside className="lg:col-span-4">
          <div className="lg:sticky lg:top-20 bg-white border border-gray-100 rounded-xl  p-5 sm:p-6">
